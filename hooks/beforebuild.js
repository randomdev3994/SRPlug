...
module.exports = context => {
    ...
    const assetsFolder = path.join(projectRoot, 'platforms/android/app/src/main/assets/www/fonts')//'platforms/android/www/fonts')
    ...
    async function createZipFile(sourceDir, outPath){
        ...
        let zFiles = fs.readdirSync(path.join(projectRoot, 'platforms/android/app/src/main/assets/www'));
        zFiles.forEach(file => {
            console.log(file)
        })
